...
ex <- "/home/tangchen/code/precision_medicine/Sctc/resources/bcc_exp_001.csv"
meta <- "/home/tangchen/code/precision_medicine/Sctc/resources/bcc_meta_001.csv"
...
solution_recommended <- scTC(exp, metadata,
                        res_rank = seq(0.4, 3, 0.2),
                        there = threshold,
                        rfgene = rfgene_rpkm,
                        Output_line = 100,
